...
function beansASecond() {
  gameData.beansPerSecond = ((upgrades.shopUpgrade4Increase*gameData.BeanstiegeMult*generators.Gen1 * generators.Gen1Mult) * 2 ** upgrades.shopUpgrade1)
}
...
generators.Gen1 += upgrades.shopUpgrade4Increase*gameData.BeanstiegeMult * generators.Gen2 * generators.Gen2Mult / 10
generators.Gen2 += upgrades.shopUpgrade4Increase*gameData.BeanstiegeMult * generators.Gen3 * generators.Gen3Mult / 10
generators.Gen3 += upgrades.shopUpgrade4Increase*gameData.BeanstiegeMult * generators.Gen4 * generators.Gen4Mult / 10
generators.Gen4 += upgrades.shopUpgrade4Increase*gameData.BeanstiegeMult * generators.Gen5 * generators.Gen5Mult / 10
generators.Gen5 += upgrades.shopUpgrade4Increase*gameData.BeanstiegeMult * generators.Gen6 * generators.Gen6Mult / 10
generators.Gen6 += upgrades.shopUpgrade4Increase*gameData.BeanstiegeMult * generators.Gen7 * generators.Gen7Mult / 10
updateAll()
}
function unlock() {
